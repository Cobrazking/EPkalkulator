...
const CalculationRow: React.FC<CalculationRowProps> = memo(({
  ...
  if (isMobile) {
    return (
      ...
      >
        {/* Header med Post, Beskrivelse og Sum - Klikkbar for å toggle collapse */}
        <button
          onClick={() => setIsCollapsed(!isCollapsed)}
          className="w-full p-3 bg-background-darker/50 border-b border-border text-left hover:bg-background-darker/70 transition-colors"
        >
