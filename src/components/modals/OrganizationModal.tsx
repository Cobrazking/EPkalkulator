  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (organization) {
        ...
        const newOrgData = {
          ...formData,
          id: '', // Will be generated by addOrganization
        ...
        // Note: In a real implementation, addOrganization would return the new organization ID
        // For now, we'll let the context handle setting the current organization
      }
