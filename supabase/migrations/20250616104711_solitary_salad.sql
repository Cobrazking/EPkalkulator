/*
  ...
  1. Functions
    - Create `get_current_user_organization_id()` helper function
    - Create `create_organization_with_user()` RPC function with proper parameter defaults
  ...
  3. Changes
    - Fix parameter default value ordering in function definition
    - Ensure proper RLS policies for organization creation
*/
...
-- Grant execute permission on the RPC functions to authenticated users
