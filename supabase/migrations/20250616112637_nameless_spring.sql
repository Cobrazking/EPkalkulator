/*
  ...
  1. Policy Issues Fixed
    - Remove circular dependencies in users table policies
    - Simplify admin and manager policies to avoid self-referencing queries
...
-- Create a function to check if user is admin (to avoid recursion in policies)
...
-- Create a function to check if user is manager or admin (to avoid recursion)
